...
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by email, following the instructions at https://github.com/viadee/vPW/blob/main/docs/Contributing/Contributing.md This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
## 1. Definitions
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://github.com/viadee/vPW/blob/main/docs/Contributing/Contributing.md
...
(d) You have followed the instructions in https://github.com/viadee/vPW/blob/main/docs/Contributing/Contributing.md, if You do not own the Copyright in the entire work of authorship Submitted.
